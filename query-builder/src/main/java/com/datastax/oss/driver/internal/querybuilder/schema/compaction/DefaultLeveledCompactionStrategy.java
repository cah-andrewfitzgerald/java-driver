...
public class DefaultLeveledCompactionStrategy
  ...
  protected DefaultLeveledCompactionStrategy(ImmutableMap<String, Object> properties) {
    super(properties);
  }

  @Override
  public DefaultLeveledCompactionStrategy withProperty(String name, Object value) {
