...
public class DefaultSizeTieredCompactionStrategy
  ...
  protected DefaultSizeTieredCompactionStrategy(ImmutableMap<String, Object> properties) {
    super(properties);
  }

  @Override
  public DefaultSizeTieredCompactionStrategy withProperty(String name, Object value) {
    return new DefaultSizeTieredCompactionStrategy(
        ImmutableCollections.append(getInternalProperties(), name, value));
  }
}
