...
public class DefaultTimeWindowCompactionStrategy
  ...
  protected DefaultTimeWindowCompactionStrategy(ImmutableMap<String, Object> properties) {
    super(properties);
  }

  @Override
  public DefaultTimeWindowCompactionStrategy withProperty(String name, Object value) {
